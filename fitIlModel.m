...
quietInd = [TexStruct.coeffInd(ignoreAnnual(TexStruct, numQuietCoeffs)),...
            OStruct.coeffInd(ignoreAnnual(OStruct, numQuietCoeffs)),...
            N2Struct.coeffInd(ignoreAnnual(N2Struct, numQuietCoeffs)),...
            HeStruct.coeffInd(ignoreAnnual(HeStruct, numQuietCoeffs)),...
            ArStruct.coeffInd(ignoreAnnual(ArStruct, numQuietCoeffs)),...
