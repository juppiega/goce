...
quietInd = [TexStruct.coeffInd(ignoreAnnualAndLongitude(TexStruct, numQuietCoeffs)),...
            OStruct.coeffInd(ignoreAnnualAndLongitude(OStruct, numQuietCoeffs)),...
            N2Struct.coeffInd(ignoreAnnualAndLongitude(N2Struct, numQuietCoeffs)),...
            HeStruct.coeffInd(ignoreAnnualAndLongitude(HeStruct, numQuietCoeffs)),...
            ArStruct.coeffInd(ignoreAnnualAndLongitude(ArStruct, numQuietCoeffs)),...
