...
plotSurfs(450, 140, 140, 90, 'He', coeffStruct, numBiasesStruct);
...
function [] = plotSurfs(heights, F, FA, doy, paramName, coeffStruct, numBiasesStruct)
