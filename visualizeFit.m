...
modelStruct = struct('il', ilRho(ind), 'msis', msisRho(ind), 'dtm', dtmRho(ind));
    ...
    plot3DOM(originalRhoStruct.dst, 25, originalRhoStruct.solarTime, 12, originalRhoStruct.data,...
    modelStruct, 'O/M', 'Dst', 'lst', saveFolder,fullscreenFigs);
   
    plot3DOM(originalRhoStruct.dst, 25, originalRhoStruct.altitude, 20, originalRhoStruct.data,...
    modelStruct, 'O/M', 'Dst', 'alt', saveFolder);
    
    plot3DOM(originalRhoStruct.dst, 25, originalRhoStruct.FA, 15, originalRhoStruct.data,...
